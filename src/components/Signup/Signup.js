      ...
      <Form className={classes.SignupForm} onSubmit={this.handleSubmit}>
        ...
        <Form.Item>
          {getFieldDecorator('confirm', {
            ...
            <Input type="password" prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="password" onBlur={this.handleConfirmBlur} />
          )}
        </Form.Item>
        <Form.Item>
          <Button className={classes.SignupFormButton} type="primary" htmlType="submit">Register</Button>
          Or <Link to="/login/"> Login if already registered</Link>
        </Form.Item>
      </Form>
    );
  }
